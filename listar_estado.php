    ...
    <!--fin alerta-->
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td scope="row"><?php echo $dato->id_estado; ?></td>
                                    <td><?php echo $dato->desc_estado; ?></td>                            
                                    <td><a class="text-success" href="editar_estado.php?codigo=<?php echo $dato->id_estado; ?>"><i class="bi bi-pencil-square"></i></a></td>
                                    <td><a onclick="return confirm('Estas seguro de eliminar?');" class="text-danger" href="eliminar_estado.php?codigo=<?php echo $dato->id_estado; ?>"><i class="bi bi-trash-fill"></i></a></td>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <form class="p-4" method="POST" action="registrar_estado.php">
                    <div class="mb-3">
